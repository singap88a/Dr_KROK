            ...
            {list.map((item) => (
              <SwiperSlide key={item.id} className="!h-auto flex pb-12">
                <article 
                  ...
                  className="w-full flex flex-col justify-between h-full min-h-[24px] p-6 transition-all duration-300 border group rounded-2xl bg-surface border-border hover:shadow-xl hover:-translate-y-1 cursor-pointer"
