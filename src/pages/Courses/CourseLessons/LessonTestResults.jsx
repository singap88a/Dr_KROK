      ...
      <div className="max-w-4xl px-4 mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="flex-1 text-2xl font-bold text-center">
            {t("courses.lessonTestResults", "Lesson Test Results")}
          </h1>
          <div className="w-10" />
        </div>
        ...
        <div className="overflow-hidden border shadow-2xl rounded-2xl bg-surface border-border">
          <div className="p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-lg text-text-muted">{t("courses.lessonTest", "Lesson Test")}</p>
            </div>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:justify-center">
              <button
                onClick={() => navigate(`/courses/${id}/lessons`, { state: { lessonCompleted: true, lessonId } })}
